...
class MyRepositoryEntityController extends AbstractRepositoryRestController implements ApplicationEventPublisherAware {
    ...
    public Resources<?> getCollectionResource(final RootResourceInformation resourceInformation,
                                              DefaultedPageable pageable,Sort sort,MyFilter filter, PersistentEntityResourceAssembler assembler)
            throws ResourceNotFoundException, HttpRequestMethodNotSupportedException {

//        System.out.println("********************pageable:"+filter);

        pageable.getPageable().setFilter(filter);

//        System.out.println("********************pageable:"+pageable.getPageable().getFilter());
//        System.out.println("********************pageable:"+pageable.getPageable().getFilter().getSpec());
//        System.out.println("********************pageable:"+sort);
        ...
        //extjs filter -> hibernate hql where
        //where 2 specificaton
        //入口，增加filter 参数
//        System.out.println("=-=-=-==-=-=-filter:"+filter.getFilter());
//        System.out.println("=-=-=-==-=-=-filter:"+filter.getSpec());
    ...
    public Resources<?> getCollectionResourceCompact(RootResourceInformation repoRequest, DefaultedPageable pageable,
        ...
        Resources<?> resources = getCollectionResource(repoRequest, pageable, sort,null, assembler);
