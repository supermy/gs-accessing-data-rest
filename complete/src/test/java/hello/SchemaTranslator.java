...
public class SchemaTranslator {
	 ...
	 * Current implementation involves usage of {@link #write(java.io.FileOutputStream, String[], org.hibernate.engine.jdbc.internal.Formatter)} method.
	...
	public static void main(String[] args) throws IOException {
		...
		Class<?>[] entityClasses = {Person.class};
